                            ...
                            <div class="aside-content">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2 mb-2">
                                        <div class="d-flex align-items-center">
                                            <figure class="me-2 mb-0">
                                                <img src="{{ url('https://via.placeholder.com/43x43') }}"
                                ...
                                <div class="aside-body">
                                    <ul class="nav nav-tabs nav-fill mt-3" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="calls-tab" data-bs-toggle="tab" data-bs-target="#calls"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="contacts-tab" data-bs-toggle="tab"
                                                data-bs-target="#contacts" role="tab" aria-controls="contacts"
                                                aria-selected="false">
                                                <div
                                                    class="d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-center">
                                                    ...
                                                    <li class="chat-item pe-1">
                                                        <a href="javascript:;" class="d-flex align-items-center">
                                                            <figure class="mb-0 me-2">
                                                                <img src="{{ url('https://via.placeholder.com/37x37') }}"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <i data-feather="arrow-up-right"
                                                                        class="icon-sm text-success me-1"></i>
                                                                    <p class="text-muted tx-13">Today, 03:11 AM</p>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-column align-items-end">
                                                                <i data-feather="phone-call"
                                                                    class="text-primary icon-md"></i>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                    ...
                                                    <a href="javascript:;" class="d-flex align-items-center">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <i data-feather="arrow-down-left"
                                                                        class="icon-sm text-danger me-1"></i>
                            ...
                            <div class="chat-header border-bottom pb-2">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center me-n1">
                                        ...
                                        <a class="me-0 me-sm-3" type="button" data-bs-toggle="tooltip"
                                            data-bs-title="Start voice call">
                                            <i data-feather="phone-call" class="icon-lg text-muted"></i>
                                        </a>
                                        <a class="d-none d-sm-block" type="button" data-bs-toggle="tooltip"
