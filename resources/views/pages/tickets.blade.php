                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                data-bs-target=".bd-example-modal-lg">Add Ticket</button>
                                                ...
                                                <div class="row align-items-start g-2">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="multiple-select-modal form-select"
                                                                    data-tags="true" name="filter_suppliers" required>
                                                                    <option value="">Select..</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input name="total" id="total-input"
                                                                    class="form-control inputmask"
                                                                    data-inputmask="'alias': 'currency', 'prefix':'SAR '"
                                                                    required>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input name="profit" id="profit-output"
                                                                    class="form-control inputmask"
                                                                    data-inputmask="'alias': 'currency', 'prefix':'SAR '"
                                                                    required>
                                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12 text-end">
                                                        <button class="btn btn-sm btn-success d-inline-block" id="print-report">
